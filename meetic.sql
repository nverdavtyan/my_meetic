...
--
-- Hôte : localhost:8889
-- Généré le : dim. 30 jan. 2022 à 21:08
...
(5, 'test123@test.com', '$2y$10$78KAnt27cPMQlb2qND8mq.Pmfyn.FvDkSHXN7.JIfb7Xl6Bzk.8kG'),
(6, 'paultest@test.com', '$2y$10$1I7hU5Hx4quzYeoCqcsItuOGApsXbRKz6WDcrm6YYhwdtq4oRYjAe'),
(7, 'jacktoto@test.com', '$2y$10$3yWdhLL4iHOW1sVCU3Jw6ucv3gA9J7NrecJ31Zdll.BAASSattXZK'),
(8, 'totobidule@test.com', '$2y$12$ajWiOJlcWD0oMGJfNpfXxe5owB/ECi5imjVc9FxVPoIM1sPAy5X.S'),
(10, 'leo@test.com', '$2y$10$8i4n1n3E6MsQXC4PElLXBu9rOhdOcpBPuPli.FTQ08Aythrhv0pre'),
(11, 'admin@test.com', '$2y$10$mMnNxbZs10CZIO4Gwoz.4.6rg2Exk4YLdFT7FakSDYtaWbyh6j12O'),
...
(562, 'nverdavtyan1994@gmail.com', '$2y$10$bQ6LZ/okEBxB72f2OdeDF.dv28vHX/ujET7Vd5faiD2UlRoXUwIcG'),
(563, 'nver.davtyan@epitech.eu', '$2y$10$HZ7SsWT6Hyunla5lzRAJj.r76UybD32ahRKZtWHYacdCbpW5E9xcm');
...
(5, 'test123', 'test123', '1982-01-05 00:00:00', 'Paris', 'homme', 1, '2021-01-24 06:27:12', 'Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression.', 0),
(6, 'Paul', 'test', '2000-05-12 00:00:00', 'Rennes', 'homme', 1, '2021-01-25 08:16:32', 'Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression.', 0),
...
(562, 'Nver', 'Davtyan', '1984-01-03 00:00:00', 'Paris', 'homme', 1, '2022-01-24 05:17:26', NULL, 0);
...
--
ALTER TABLE `login`
  MODIFY `id_users` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=564;
