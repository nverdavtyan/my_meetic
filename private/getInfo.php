...
class getInfo
{
    ...
    function __construct($db)
    {
        ...
        $this->fetch = new fetch($db);
        $this->fetch2 = new fetch($db);
    }

    public function getHobbies()
    {
        $SQL = "SELECT * FROM hobbies";
        $this->fetch->query($SQL, $this->arrayHobbies);
    ...
    public function userInfo($email)
    {
        ...
        $this->fetch->query($SQL, $this->userInfo);
    ...
    public function resultInfo()
    {
        ...
        $this->fetch->query($SQL, $this->resultInfo);
    ...
    public function sessionInfo()
    {
        ...
        $this->fetch2->query($SQL, $this->sessionInfo);
